...
@override
String toString() {
  return 'AchievementDto(id: $id, achievementName: $achievementName, description: $description, icon: $icon, levelId: $levelId, tags: $tags, templateId: $templateId)';
}
...
class _AchievementDto extends AchievementDto {
  const _AchievementDto({required this.id, required this.achievementName, this.description, this.icon, this.levelId, final  List<String> tags = const [], this.templateId}): _tags = tags,super._();
